...
import { handleClearSelectedCinemaDetail } from "../../../reducers/apiCinemaDetail";
...
const PurchaseFilmCard = ({ item }) => {
    ...
    return(
        ...
        >
            {
                selectedFilm.id == item.id && <FontAwesomeIcon icon={faCircleCheck} className="purchase-film-item-ticked" />
            }
            <img 
