  ...
  return (
    <div className="trailer-container">
      ...
      <div className="trailer-infor">
        <img className="trailer-img" src={film.image} />
        <div className="trailer-infor-content">
          <p className="trailer-infor-title">{film.nameFilm.toUpperCase()}</p>
          <p className="trailer-infor-descri">{film.description}</p>
